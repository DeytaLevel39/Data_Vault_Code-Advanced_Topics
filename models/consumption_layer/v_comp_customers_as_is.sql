with
    ...
    joined as
        (select h.customer_hk, h.customer_number, s_uk.crud_flag, s_uk.customer_id,
                s_uk_1.title, s_uk.first_name, s_uk.last_name, s_uk.lastmodifieddate, s_uk.createddate, s_uk.applieddate,
         ...
         select h.customer_hk, h.customer_number, s_us.crud_flag, s_us.customer_id,
                '' as title, s_us.first_name, s_us.last_name, s_us.lastmodifieddate, s_us.createddate, s_us.applieddate,
...
select customer_hk, customer_id, customer_number, title, first_name, last_name, lastmodifieddate, createddate, applieddate, effective_from, load_date, record_source from joined
